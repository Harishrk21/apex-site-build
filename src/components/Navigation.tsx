...
const Navigation = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="flex justify-between items-center h-16 md:h-18 lg:h-20">{/* Logo */}
          <button
...
/>
  ...
  <span className="text-xs md:text-xs text-gray-600 font-semibold tracking-wider whitespace-nowrap">
    WELLNESS CENTRE
      ...
      {/* Mobile menu */}
      <div className={`
        lg:hidden fixed inset-0 bg-white z-40 transform transition-all duration-300 ease-in-out
  ...
  src="/mylogo.png"
  alt="New Life Wellness Centre Logo"
  className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 object-contain transition-transform duration-300 group-hover:scale-105"
/>

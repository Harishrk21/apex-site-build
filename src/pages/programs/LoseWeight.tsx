...
const LoseWeight = () => {
  const dailyPlan = [
    ...
    },
    {
      ...
      meal: "Herbal Tea or Total Control",
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "The program typically includes Formula 1 Shake Mix, Personalized Protein Powder, Herbal Tea Concentrate, and Total Control. Your coach will customize the product selection based on your specific needs and goals."
    },
    {
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-gray-600 max-w-2xl mx-auto">
              See what a typical day looks like in our program
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              "Access to exclusive challenges and community",
            ...
            <CardContent className="p-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <h3 className="text-2xl font-bold mb-4">Priya's Transformation</h3>
                  <div className="space-y-3 text-muted-foreground mb-6">
                    <p><strong className="text-foreground">Goal:</strong> Lose 15 kg after pregnancy</p>
                    <p><strong className="text-foreground">Plan:</strong> Standard 3-month program with Formula 1, Personalized Protein, and Total Control</p>
                    <p><strong className="text-foreground">Result:</strong> Lost 16 kg in 3 months, regained energy, improved confidence</p>
                    <p><strong className="text-foreground">Timeline:</strong> Started January 2024, achieved goal by April 2024</p>
                  </div>
                  <p className="italic text-foreground">
                    "The personalized approach made all the difference. My coach understood my challenges as a new mom and created a plan that worked with my schedule. The products made it so easy to stay on track, and the support was incredible. I feel like myself again!"
                  </p>
                  <p className="mt-4 font-semibold">— Priya S., Chennai</p>
                </div>
